...
<title>Megam :: Contact Us</title>
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBaX2x2Y_BEpBGo5X0GGxLQTKa_PVmgrZE&sensor=false"></script>
...
<div class="header-menu-inner">
  <nav class="inner-page navbar navbar-default  navbar-fixed-top">
    <div class="container">
...
<div class=" container">
  <div class="touch">
    ...
    <p class="inner-pragraph">We would love to hear  from you.  Do you have other questions?  Don't worry, there aren't any dumb questions. Just fill out the form below and we'll get back to you as soon as possible (usually within one business day).</p>
  </div>
</div>
<div class="enquiry">
  <div class="container">
    <div class="col-md-7 col-sm-6 address row">
        ...
        <div class="row">
          <form class=" form-group">
            <div class="col-md-6 col-sm-7 row">
              <input type="email" placeholder="Email address" class="form-control subscribe-input" id="inputEmail">
            </div>
            <div class="col-md-6 col-sm-7 row">
...
scrollwheel: false,
          scaleControl: true,
    zoom: 16,
    center: new google.maps.LatLng(12.908768, 80.195775),
    zoomControl: true,
zoomControlOptions: {
